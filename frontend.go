...
func main() {
	wg.Add(1)
	go newFrontend("0.0.0.0:10301", "127.0.0.1:10205")
	go newFrontend("0.0.0.0:10302", "127.0.0.1:10205")
	go newFrontend("0.0.0.0:10303", "127.0.0.1:10205")
	wg.Wait()
}

func newFrontend(laddr, raddr string) {
	defer func() {
		/*if r := recover(); r != nil {*/
		//log.Println("panic =>", r)
		/*}*/
